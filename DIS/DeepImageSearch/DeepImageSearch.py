...
class Search_Setup:
    ...
    def _search_by_vector(self, v, n: int):
        ...
        return D, dict(zip(I[0], self.image_data.iloc[I[0]]['images_paths'].to_list()))
    ...
    def plot_similar_images(self, image_path: str, number_of_images: int = 6):
        ...
        d, img_list = list(self._search_by_vector(query_vector, number_of_images).values())
    ...
    def get_similar_images(self, image_path: str, number_of_images: int = 10):
        ...
        d, img_dict = self._search_by_vector(query_vector, self.number_of_images)
        return d, img_dict
